...
typedef struct opennsl_l3_egress_s {
    ...
    opennsl_module_t reserved1; 
    opennsl_port_t port;            /**< Port packet switched to (if
                                       !OPENNSL_L3_TGID). */
    opennsl_trunk_t reserved2; 
    uint32 reserved3; 
    opennsl_mpls_label_t reserved4; 
    int reserved5; 
    int reserved6; 
    uint8 reserved7; 
    uint8 reserved8; 
...
typedef struct opennsl_l3_route_s {
    ...
    opennsl_ip_t reserved1; 
    opennsl_mac_t reserved2; 
    opennsl_module_t reserved3; 
    opennsl_port_t reserved4; 
    opennsl_port_t reserved5; 
    opennsl_vlan_t reserved6; 
...
/***************************************************************************//** 
 *\brief Initialize a opennsl_l3_intf_t/opennslx_l3_intf_t structure.
 *
...
/***************************************************************************//** 
 *\brief Initialize a opennsl_l3_egress_t/opennslx_l3_egress_t structure.
 *
...
/***************************************************************************//** 
 *\brief Initialize a opennsl_l3_host_t/opennslx_l3_host_t structure.
 *
...
/***************************************************************************//** 
 *\brief Initialize a opennsl_l3_route_t/opennslx_l3_route_t_init structure.
 *
