...
typedef struct opennsl_l2_addr_s {
    ...
    opennsl_mac_t reserved1; 
    opennsl_vlan_t reserved2; 
    int reserved3; 
    int reserved4; 
    opennsl_trunk_t reserved5; 
    opennsl_cos_t reserved6; 
    opennsl_cos_t reserved7; 
    opennsl_multicast_t reserved8; 
    opennsl_pbmp_t reserved9; 
    int reserved10; 
    int reserved11; 
    opennsl_fabric_distribution_t reserved12; 
    int reserved13; 
} opennsl_l2_addr_t;
