 ...
 *          For opennslx_linkscan_enable_set, if consistent is non-NULL, then
 *          the linkscan rate value is checked across all devices.  If it is
 *          the same for all devices, *consistent is set to TRUE.  Otherwise,
 *          it is set to FALSE.
 *
 *\param    unit [IN]   Unit number.
